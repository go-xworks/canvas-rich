...
export const LIGHT: CanvasPalette = {
  ...
  muted: [0.42, 0.447, 0.502, 1], // 引用/弱化 #6b7280
  title: [0.059, 0.067, 0.09, 1], // H1 #0f1117（层级靠字号字重，不再用彩色）
  h2: [0.2, 0.216, 0.239, 1], // H2 #33373d
  link: [0.145, 0.388, 0.922, 1], // 链接 #2563eb
  code: [0.176, 0.192, 0.22, 1], // 行内代码文字 #2d3138
  codeText: [0.176, 0.192, 0.22, 1], // 代码块文字 #2d3138
  ...
  findMatch: [0.961, 0.62, 0.043, 0.3], // 查找命中琥珀 wash rgba(245,158,11,.30)
  caret: [0.059, 0.067, 0.09, 1], // 光标 #0f1117（深色，白底可见）
...
export const DARK: CanvasPalette = {
  ...
  h2: [0.831, 0.851, 0.89, 1], // H2–H6 #d4d9e3
  ...
  findMatch: [0.961, 0.62, 0.043, 0.38], // 查找命中琥珀 wash（深底上加大 alpha 提可见度）
  caret: [0.965, 0.972, 0.984, 1], // 光标 #f6f8fb（浅色，深底可见）
  marker: [0.49, 0.514, 0.573, 1], // 列表标记 #7d8392
  pageGap: [0.063, 0.067, 0.09, 1], // word 视图页缝 #101117（比纸面更深，衬出纸张）
};
