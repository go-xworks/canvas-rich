...
const PATHS: Record<string, string> = {
  ...
  'align-distribute': '<line x1="3" x2="21" y1="6" y2="6"/><line x1="3" x2="21" y1="12" y2="12"/><line x1="3" x2="15" y1="18" y2="18"/><circle cx="19" cy="18" r="1.4"/>',
  ...
  'paperclip': '<path d="M13.234 20.252 21 12.3a4.6 4.6 0 0 0-6.5-6.5l-9.5 9.5a3 3 0 0 0 4.243 4.243l7.5-7.5a1.5 1.5 0 0 0-2.121-2.121L7.5 16.5"/>',
  // 电子签名 / 印章：手写签名（signature）+ 公章（stamp）。
  'signature': '<path d="m3 17 2 2"/><path d="M5 19c2-1 3-3 3-6 0-2-1-3-2-3s-1.5 1-1.5 2.5C4.5 16 8 18 12 16c2-1 3-3 3-5 0-1.5-.8-2.5-2-2.5s-2 1-2 2.5c0 3 3 5 7 4"/>',
  'stamp': '<path d="M5 22h14"/><path d="M19.27 18c.42-.5.73-1.16.73-2 0-1.66-1.5-2.5-3-3l-1-3.5a3 3 0 0 0 1-2.5V5a3 3 0 0 0-3-3h-2a3 3 0 0 0-3 3v1.5a3 3 0 0 0 1 2.5L9 12c-1.5.5-3 1.34-3 3 0 .84.31 1.5.73 2Z"/>',
  // 文本框：text-box（带文本行的矩形框）。
  'text-box': '<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M7 8h10"/><path d="M7 12h10"/><path d="M7 16h6"/>',
